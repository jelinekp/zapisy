...
if(isset($_POST["sent"])) {
  ...
  $query->execute(array(substr($_POST["subject"], 0, strpos($_POST["subject"], ';')), $_POST["range"], date("Y-m-d", $date), $_POST["notes"], $_POST["author"], substr($_POST["subject"], strpos($_POST["subject"], ';') + 1)));
